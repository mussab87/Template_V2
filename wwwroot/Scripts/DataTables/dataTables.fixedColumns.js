...
// ***********************************************************************
// <copyright file="dataTables.fixedColumns.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
$.extend( FixedColumns.prototype , {
	...
	"fnSetRowHeight": function ( nTarget, iHeight )
	{
		/// <summary>
		/// </summary>
		/// <param name="nTarget">The n target.</param>
	...
	"_fnDraw": function ( bAll )
	{
		/// <summary>
		/// </summary>
		/// <param name="bAll">The b all.</param>
		this._fnGridLayout();
	...
	"_fnCopyLayout": function ( aoOriginal, aiColumns, events )
	{
		/// <summary>
		/// </summary>
		/// <param name="aoOriginal">The ao original.</param>
		/// <param name="aiColumns">The ai columns.</param>
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		/// <summary>
		/// </summary>
		/// <param name="oClone">The o clone.</param>
