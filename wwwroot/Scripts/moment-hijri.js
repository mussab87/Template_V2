...
// ***********************************************************************
// <copyright file="moment-hijri.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
/// </summary>
  ...
  ************************************/
	...
	function makeDateFromStringAndFormat(config) {
		/// <summary>
		/// Makes the date from string and format.
		/// </summary>
		/// <param name="config">The configuration.</param>
	...
	function makeDateFromStringAndArray(config, utc) {
		/// <summary>
		/// Makes the date from string and array.
		/// </summary>
		/// <param name="config">The configuration.</param>
  ...
  ************************************/
	...
	function iWeekOfYear(mom, firstDayOfWeek, firstDayOfWeekOfYear) {
		...
		/// <param name="firstDayOfWeekOfYear">The first day of week of year.</param>
  ...
  */
	function getNewMoonMJDNIndex(hy, hm) {
		/// <summary>
		/// Gets the new index of the moon MJDN.
		/// </summary>
		/// <param name="hy">The hy.</param>
		/// <param name="hm">The hm.</param>
		var cYears = hy - 1,
  ...
  */
	function getNewMoonMJDNIndexByJDN(mjdn) {
		/// <summary>
		/// Gets the new moon MJDN index by JDN.
		/// </summary>
		/// <param name="mjdn">The MJDN.</param>
