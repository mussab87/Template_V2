...
// ***********************************************************************
// <copyright file="TableTools_orig.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
TableTools.prototype = {
	...
	"fnGetTitle": function( oConfig )
	{
		/// <summary>
		/// </summary>
		/// <param name="oConfig">The o configuration.</param>
		var sTitle = "";
	...
	"fnPrint": function ( bView, oConfig )
	{
		/// <summary>
		/// </summary>
		/// <param name="bView">The b view.</param>
		/// <param name="oConfig">The o configuration.</param>
	...
	"_fnButtonDefinations": function ( buttonSet, wrapper )
	{
		/// <summary>
		/// </summary>
		/// <param name="buttonSet">The button set.</param>
	...
	"_fnCreateButton": function ( oConfig, bCollectionButton )
	{
	  ...
	  /// </summary>
	  /// <param name="oConfig">The o configuration.</param>
	  /// <param name="bCollectionButton">The b collection button.</param>
	...
	"_fnCollectionConfig": function ( nButton, oConfig )
	{
		/// <summary>
		/// </summary>
		/// <param name="nButton">The n button.</param>
		/// <param name="oConfig">The o configuration.</param>
	...
	"_fnColumnTargets": function ( mColumns )
	{
		/// <summary>
		/// </summary>
		/// <param name="mColumns">The m columns.</param>
		var aColumns = [];
		var dt = this.s.dt;
	...
	"_fnBoundData": function ( sData, sBoundary, regex )
	{
		...
		/// </summary>
		/// <param name="sData">The s data.</param>
		/// <param name="sBoundary">The s boundary.</param>
	 ...
	 $.fn.dataTableExt.fnVersionCheck('1.9.0') )
{
	$.fn.dataTableExt.aoFeatures.push( {
		"fnInit": function( oDTSettings ) {
			/// <summary>
			/// </summary>
			/// <param name="oDTSettings">The o dt settings.</param>
