...
// ***********************************************************************
// <copyright file="jquery.validate-vsdoc.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
$.extend($.fn, {
	...
	validate: function( options ) {
		...
		/// </summary>
		/// <param name="options">A set of key/value pairs that configure the validate. All options are optional.</param>
	...
	removeAttrs: function(attributes) {
		...
		/// </summary>
		/// <param name="attributes">A space-seperated list of attribute names to remove.</param>
	...
	rules: function(command, argument) {
		...
		/// </summary>
		/// <param name="command">Can be either "add" or "remove".</param>
		/// <param name="argument">A list of rules to add or remove.</param>
...
$.validator.format = function(source, params) {
	...
	/// <param name="params">The first argument to insert, or an array of Strings to insert</param>
...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		...
		/// </summary>
		/// <param name="settings">Options to set as default.</param>
	...
	prototype: {
		...
		element: function( element ) {
			...
			/// </summary>
			/// <param name="element">An element to validate, must be inside the validated form.</param>
		...
		showErrors: function(errors) {
			...
			/// </summary>
			/// <param name="errors">One or more key/value pairs of input names and messages.</param>
	...
	addMethod: function(name, method, message) {
		...
		/// </summary>
		/// <param name="name">The name of the method, used to identify and referencing it, must be a valid javascript
		/// identifier</param>
		/// <param name="method">The actual method implementation, returning true if an element is valid</param>
		/// <param name="message">(handy for localization), otherwise the field-specific messages have to be defined.</param>
