...
// ***********************************************************************
// <copyright file="jquery.calendars.all.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
	...
	$.extend($.calendars.baseCalendar.prototype, {
		...
		formatDate: function(format, date, settings) {
			...
			var formatName = function(match, value, shortNames, longNames) {
				...
				/// <param name="longNames">The long names.</param>
		...
		determineDate: function(dateSpec, defaultDate, currentDate, dateFormat, settings) {
			/// <summary>
			/// </summary>
			/// <param name="dateSpec">The date spec.</param>
...
(function($) { // Hide scope, no $ conflict
	...
	alert('Now in ' + month + '/' + year);
 	...
 	alert('Selected ' + dates);
		...
		_extractDates: function(inst, datesText) {
			...
			/// </summary>
			/// <param name="inst">The inst.</param>
			/// <param name="datesText">The dates text.</param>
		...
		_updateInput: function(elem, keyUp) {
			...
			/// </summary>
			/// <param name="elem">The elem.</param>
			/// <param name="keyUp">The key up.</param>
			var inst = this._getInst(elem);
			if (!$.isEmptyObject(inst)) {
				var value = '';
				var altValue = '';
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
		setDate: function(elem, dates, endDate, keyUp, setOpt) {
			...
			/// <param name="keyUp">The key up.</param>
			/// <param name="setOpt">The set opt.</param>
			var inst = this._getInst(elem);
			if (!$.isEmptyObject(inst)) {
				if (!$.isArray(dates)) {
					dates = [dates];
		...
		_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader, calendar) {
			...
			/// <param name="minDate">The minimum date.</param>
			/// <param name="maxDate">The maximum date.</param>
			/// <param name="monthHeader">The month header.</param>
			/// <param name="calendar">The calendar.</param>
			...
			if (yearRange === 'any') {
				...
				var addYear = function(y, yDisplay) {
					...
					/// <param name="yDisplay">The y display.</param>
		...
		_prepare: function(text, inst) {
			...
			var replaceSection = function(type, retain) {
				...
				/// </summary>
				/// <param name="type">The type.</param>
				/// <param name="retain">The retain.</param>
				while (true) {
