...
// Last Modified On : 01-17-2016
// ***********************************************************************
// <copyright file="jquery.calendars.nepali.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
(function($) { // Hide scope, no $ conflict
	...
	$.extend(NepaliCalendar.prototype, {
		...
		toJD: function(nepaliYear, nepaliMonth, nepaliDay) {
			/// <summary>
			/// </summary>
			/// <param name="nepaliYear">The nepali year.</param>
			/// <param name="nepaliMonth">The nepali month.</param>
			/// <param name="nepaliDay">The nepali day.</param>
