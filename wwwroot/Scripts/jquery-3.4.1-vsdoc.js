...
// ***********************************************************************
// <copyright file="jquery-3.4.1-vsdoc.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
(function (window, undefined) {
    ...
    jQuery.Callbacks = function (options) {
        ...
        /// </summary>
        /// <param name="options">An optional list of space-separated flags that change how the callback list behaves.</param>
    ...
    jQuery.Deferred = function (func) {
        ...
        /// </summary>
        /// <param name="func">A function that is called just before the constructor returns.</param>
    ...
    jQuery.ajax = function (url, options) {
        ...
        /// <param name="options">A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.</param>
    ...
    jQuery.ajaxPrefilter = function (dataTypeExpression, func) {
        ...
        /// </summary>
        /// <param name="dataTypeExpression">An optional string containing one or more space-separated dataTypes</param>
        /// <param name="func">A handler to set default values for future Ajax requests.</param>
    ...
    jQuery.ajaxSetup = function (target, settings) {
        ...
        /// </summary>
        /// <param name="target">A set of key/value pairs that configure the default Ajax request. All options are optional.</param>
    ...
    jQuery.ajaxTransport = function (dataTypeExpression, func) {
        ...
        /// </summary>
        /// <param name="dataTypeExpression">A string identifying the data type to use</param>
        /// <param name="func">A handler to return the new transport object to use with the data type provided in the first argument.</param>
    ...
    jQuery.contains = function (context, elem) {
        ...
        /// </summary>
        /// <param name="context">The DOM element that may contain the other element.</param>
        /// <param name="elem">The DOM element that may be contained by (a descendant of) the other element.</param>
    ...
    jQuery.data = function (elem, name, data) {
        ...
        /// </summary>
        /// <param name="elem">The DOM element to associate with the data.</param>
        /// <param name="name">A string naming the piece of data to set.</param>
    ...
    jQuery.dequeue = function (elem, type) {
        ...
        /// </summary>
        /// <param name="elem">A DOM element from which to remove and execute a queued function.</param>
        /// <param name="type">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ...
    jQuery.error = function (msg) {
        ...
        /// </summary>
        /// <param name="msg">The message to send out.</param>
    ...
    jQuery.get = function (url, data, callback, type) {
        ...
        /// <param name="type">The type of data expected from the server. Default: Intelligent Guess (xml, json, script, or html).</param>
    ...
    jQuery.grep = function (elems, callback, inv) {
        ...
        /// </summary>
        /// <param name="elems">The array to search through.</param>
        ...
        /// <param name="inv">If "invert" is false, or not provided, then the function returns an array consisting of all elements for which "callback" returns true.  If "invert" is true, then the function returns an array consisting of all elements for which "callback" returns false.</param>
    ...
    jQuery.hasData = function (elem) {
        ...
        /// </summary>
        /// <param name="elem">A DOM element to be checked for data.</param>
    ...
    jQuery.inArray = function (elem, arr, i) {
        ...
        /// <param name="arr">An array through which to search.</param>
        /// <param name="i">The index of the array at which to begin the search. The default is 0, which will search the whole array.</param>
    ...
    jQuery.isXMLDoc = function (elem) {
        ...
        /// </summary>
        /// <param name="elem">The DOM node that will be checked to see if it's in an XML document.</param>
    ...
    jQuery.makeArray = function (arr, results) {
        ...
        /// </summary>
        /// <param name="arr">Any object to turn into a native Array.</param>
        /// <param name="results">The results.</param>
    ...
    jQuery.map = function (elems, callback, arg) {
        ...
        /// </summary>
        /// <param name="elems">The Array to translate.</param>
    ...
    jQuery.noConflict = function (deep) {
        ...
        /// </summary>
        /// <param name="deep">A Boolean indicating whether to remove all jQuery variables from the global scope (including jQuery itself).</param>
...
/// </summary>
    ...
    jQuery.param = function (a, traditional) {
        ...
        /// </summary>
        /// <param name="a">An array or object to serialize.</param>
    ...
    jQuery.parseHTML = function (data, context, keepScripts) {
        ...
        /// <param name="context">DOM element to serve as the context in which the HTML fragment will be created</param>
    ...
    jQuery.post = function (url, data, callback, type) {
        ...
        /// <param name="data">A plain object or string that is sent to the server with the request.</param>
        /// <param name="callback">A callback function that is executed if the request succeeds.</param>
        /// <param name="type">The type of data expected from the server. Default: Intelligent Guess (xml, json, script, text, html).</param>
    ...
    jQuery.proxy = function (fn, context) {
        ...
        /// </summary>
        /// <param name="fn">The function whose context will be changed.</param>
    ...
    jQuery.queue = function (elem, type, data) {
        ...
        /// <param name="type">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
        /// <param name="data">An array of functions to replace the current queue contents.</param>
    ...
    jQuery.removeData = function (elem, name) {
        ...
        /// </summary>
        /// <param name="elem">A DOM element from which to remove data.</param>
    ...
    jQuery.unique = function (results) {
        ...
        /// </summary>
        /// <param name="results">The Array of DOM elements.</param>
    ...
    jQuery.prototype.addClass = function (value) {
        ...
        /// </summary>
        /// <param name="value">One or more space-separated classes to be added to the class attribute of each matched element.</param>
    ...
    jQuery.prototype.animate = function (prop, speed, easing, callback) {
        ...
        /// </summary>
        /// <param name="prop">An object of CSS properties and values that the animation will move toward.</param>
        /// <param name="speed">A string or number determining how long the animation will run.</param>
    ...
    jQuery.prototype.appendTo = function (selector) {
        ...
        /// </summary>
        /// <param name="selector">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the end of the element(s) specified by this parameter.</param>
    ...
    jQuery.prototype.bind = function (types, data, fn) {
        ...
        /// 3 - bind(events)
        /// </summary>
        /// <param name="types">A string containing one or more DOM event types, such as "click" or "submit," or custom event names.</param>
        /// <param name="data">An object containing data that will be passed to the event handler.</param>
        /// <param name="fn">A function to execute each time the event is triggered.</param>
    ...
    jQuery.prototype.children = function (until, selector) {
        ...
        /// </summary>
        /// <param name="until">A string containing a selector expression to match elements against.</param>
        /// <param name="selector">The selector.</param>
    ...
    jQuery.prototype.clone = function (dataAndEvents, deepDataAndEvents) {
        ...
        /// </summary>
        /// <param name="dataAndEvents">A Boolean indicating whether event handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
        /// <param name="deepDataAndEvents">A Boolean indicating whether event handlers and data for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ...
    jQuery.prototype.closest = function (selectors, context) {
        ...
        /// </summary>
        /// <param name="selectors">A string containing a selector expression to match elements against.</param>
    ...
    jQuery.prototype.delay = function (time, type) {
        ...
        /// </summary>
        /// <param name="time">An integer indicating the number of milliseconds to delay execution of the next item in the queue.</param>
        /// <param name="type">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ...
    jQuery.prototype.delegate = function (selector, types, data, fn) {
        ...
        /// <param name="types">A string containing one or more space-separated JavaScript event types, such as "click" or "keydown," or custom event names.</param>
        /// <param name="data">An object containing data that will be passed to the event handler.</param>
        /// <param name="fn">A function to execute at the time the event is triggered.</param>
    ...
    jQuery.prototype.domManip = function (args, callback, allowIntersection) {
        ...
        /// <param name="args">The arguments.</param>
        /// <param name="callback">The callback.</param>
        /// <param name="allowIntersection">The allow intersection.</param>
    ...
    jQuery.prototype.eq = function (i) {
        ...
        /// 2 - eq(-index)
        /// </summary>
        /// <param name="i">An integer indicating the 0-based position of the element.</param>
    ...
    jQuery.prototype.fadeTo = function (speed, to, easing, callback) {
        ...
        /// </summary>
        /// <param name="speed">A string or number determining how long the animation will run.</param>
        /// <param name="to">A number between 0 and 1 denoting the target opacity.</param>
        /// <param name="easing">A string indicating which easing function to use for the transition.</param>
        /// <param name="callback">A function to call once the animation is complete.</param>
    ...
    jQuery.prototype.finish = function (type) {
        ...
        /// </summary>
        /// <param name="type">The name of the queue in which to stop animations.</param>
    ...
    jQuery.prototype.get = function (num) {
        ...
        /// </summary>
        /// <param name="num">A zero-based integer indicating which element to retrieve.</param>
    ...
    jQuery.prototype.has = function (target) {
        ...
        /// 2 - has(contained)
        /// </summary>
        /// <param name="target">A string containing a selector expression to match elements against.</param>
    ...
    jQuery.prototype.hasClass = function (selector) {
        ...
        /// </summary>
        /// <param name="selector">The class name to search for.</param>
    ...
    jQuery.prototype.height = function (margin, value) {
        ...
        /// </summary>
        /// <param name="margin">An integer representing the number of pixels, or an integer with an optional unit of measure appended (as a string).</param>
        /// <param name="value">The value.</param>
    ...
    jQuery.prototype.hover = function (fnOver, fnOut) {
        ...
        /// </summary>
        /// <param name="fnOver">A function to execute when the mouse pointer enters the element.</param>
        /// <param name="fnOut">A function to execute when the mouse pointer leaves the element.</param>
    ...
    jQuery.prototype.html = function (value) {
        ...
        /// </summary>
        /// <param name="value">A string of HTML to set as the content of each matched element.</param>
    ...
    jQuery.prototype.index = function (elem) {
        ...
        /// 3 - index(element)
        /// </summary>
        /// <param name="elem">A selector representing a jQuery collection in which to look for an element.</param>
    ...
    jQuery.prototype.init = function (selector, context, rootjQuery) {
        ...
        /// <param name="selector">The selector.</param>
        /// <param name="context">The context.</param>
        /// <param name="rootjQuery">The rootj query.</param>
        var match, elem;
    ...
    jQuery.prototype.insertAfter = function (selector) {
        ...
        /// </summary>
        /// <param name="selector">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted after the element(s) specified by this parameter.</param>
    ...
    jQuery.prototype.insertBefore = function (selector) {
        ...
        /// </summary>
        /// <param name="selector">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted before the element(s) specified by this parameter.</param>
    ...
    jQuery.prototype.load = function (url, params, callback) {
        ...
        /// </summary>
        /// <param name="url">A string containing the URL to which the request is sent.</param>
        /// <param name="params">A plain object or string that is sent to the server with the request.</param>
    ...
    jQuery.prototype.nextUntil = function (until, selector) {
        ...
        /// </summary>
        /// <param name="until">A string containing a selector expression to indicate where to stop matching following sibling elements.</param>
        /// <param name="selector">A string containing a selector expression to match elements against.</param>
    ...
    jQuery.prototype.off = function (types, selector, fn) {
        ...
        /// </summary>
        /// <param name="types">One or more space-separated event types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".</param>
        /// <param name="selector">A selector which should match the one originally passed to .on() when attaching event handlers.</param>
        /// <param name="fn">A handler function previously attached for the event(s), or the special value false.</param>
    ...
    jQuery.prototype.offset = function (options) {
        ...
        /// </summary>
        /// <param name="options">An object containing the properties top and left, which are integers indicating the new top and left coordinates for the elements.</param>
    ...
    jQuery.prototype.on = function (types, selector, data, fn, /*INTERNAL*/ one) {
        ...
        /// </summary>
        /// <param name="types">One or more space-separated event types and optional namespaces, such as "click" or "keydown.myPlugin".</param>
        ...
        /// <param name="fn">A function to execute when the event is triggered. The value false is also allowed as a shorthand for a function that simply does return false.</param>
    ...
    jQuery.prototype.outerHeight = function (margin, value) {
        ...
        /// </summary>
        /// <param name="margin">A Boolean indicating whether to include the element's margin in the calculation.</param>
        /// <param name="value">The value.</param>
    ...
    jQuery.prototype.parentsUntil = function (until, selector) {
        ...
        /// </summary>
        /// <param name="until">A string containing a selector expression to indicate where to stop matching ancestor elements.</param>
        /// <param name="selector">A string containing a selector expression to match elements against.</param>
    ...
    jQuery.prototype.prependTo = function (selector) {
        ...
        /// </summary>
        /// <param name="selector">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the beginning of the element(s) specified by this parameter.</param>
    ...
    jQuery.prototype.prevUntil = function (until, selector) {
        ...
        /// </summary>
        /// <param name="until">A string containing a selector expression to indicate where to stop matching preceding sibling elements.</param>
        /// <param name="selector">A string containing a selector expression to match elements against.</param>
    ...
    jQuery.prototype.promise = function (type, obj) {
        ...
        /// <param name="obj">Object onto which the promise methods have to be attached</param>
    ...
    jQuery.prototype.pushStack = function (elems) {
        ...
        /// </summary>
        /// <param name="elems">An array of elements to push onto the stack and make into a new jQuery object.</param>
    ...
    jQuery.prototype.ready = function (fn) {
        ...
        /// </summary>
        /// <param name="fn">A function to execute after the DOM is ready.</param>
    ...
    jQuery.prototype.removeAttr = function (name) {
        ...
        /// </summary>
        /// <param name="name">An attribute to remove; as of version 1.7, it can be a space-separated list of attributes.</param>
    ...
    jQuery.prototype.removeClass = function (value) {
        ...
        /// </summary>
        /// <param name="value">One or more space-separated classes to be removed from the class attribute of each matched element.</param>
    ...
    jQuery.prototype.removeData = function (key) {
        ...
        /// 2 - removeData(list)
        /// </summary>
        /// <param name="key">A string naming the piece of data to delete.</param>
    ...
    jQuery.prototype.replaceAll = function (selector) {
        ...
        /// </summary>
        /// <param name="selector">A selector string, jQuery object, or DOM element reference indicating which element(s) to replace.</param>
    ...
    jQuery.prototype.scrollLeft = function (val) {
        ...
        /// </summary>
        /// <param name="val">An integer indicating the new position to set the scroll bar to.</param>
    ...
    jQuery.prototype.stop = function (type, clearQueue, gotoEnd) {
        ...
        /// <param name="gotoEnd">A Boolean indicating whether to complete the current animation immediately. Defaults to false.</param>
    ...
    jQuery.prototype.text = function (value) {
        ...
        /// </summary>
        /// <param name="value">A string of text to set as the content of each matched element.</param>
    ...
    jQuery.prototype.toggle = function (speed, easing, callback) {
        ...
        /// </summary>
        /// <param name="speed">A function to execute every even time the element is clicked.</param>
        /// <param name="easing">A function to execute every odd time the element is clicked.</param>
        /// <param name="callback">Additional handlers to cycle through after clicks.</param>
    ...
    jQuery.prototype.toggleClass = function (value, stateVal) {
        ...
        /// </summary>
        /// <param name="value">One or more class names (separated by spaces) to be toggled for each element in the matched set.</param>
        /// <param name="stateVal">A Boolean (not just truthy/falsy) value to determine whether the class should be added or removed.</param>
    ...
    jQuery.prototype.trigger = function (type, data) {
        ...
        /// </summary>
        /// <param name="type">A string containing a JavaScript event type, such as click or submit.</param>
        /// <param name="data">Additional parameters to pass along to the event handler.</param>
    ...
    jQuery.prototype.triggerHandler = function (type, data) {
        ...
        /// </summary>
        /// <param name="type">A string containing a JavaScript event type, such as click or submit.</param>
        /// <param name="data">An array of additional parameters to pass along to the event handler.</param>
    ...
    jQuery.prototype.unbind = function (types, fn) {
        ...
        /// 3 - unbind(event)
        /// </summary>
        /// <param name="types">A string containing a JavaScript event type, such as click or submit.</param>
        /// <param name="fn">The function that is to be no longer executed.</param>
    ...
    jQuery.prototype.undelegate = function (selector, types, fn) {
        ...
        /// <param name="types">A string containing a JavaScript event type, such as "click" or "keydown"</param>
        /// <param name="fn">A function to execute at the time the event is triggered.</param>
    ...
    jQuery.prototype.unload = function (data, fn) {
        ...
        /// </summary>
        /// <param name="data">A plain object of data that will be passed to the event handler.</param>
        /// <param name="fn">A function to execute each time the event is triggered.</param>
    ...
    jQuery.prototype.width = function (margin, value) {
        ...
        /// </summary>
        /// <param name="margin">An integer representing the number of pixels, or an integer along with an optional unit of measure appended (as a string).</param>
        /// <param name="value">The value.</param>
    ...
    jQuery.prototype.wrap = function (html) {
        ...
        /// </summary>
        /// <param name="html">A selector, element, HTML string, or jQuery object specifying the structure to wrap around the matched elements.</param>
    ...
    jQuery.prototype.wrapInner = function (html) {
        ...
        /// </summary>
        /// <param name="html">An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the content of the matched elements.</param>
