...
// ***********************************************************************
// <copyright file="conflict-detection.js" company="Expert Systems">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
/// <param name="exports">The exports.</param>
  ...
  function report (_ref) {
    /// <summary>
    /// Reports the specified reference.
    /// </summary>
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      function binl2rstr(input) {
        /// <summary>
        /// Binl2rstrs the specified input.
        /// </summary>
      ...
      function rstr2binl(input) {
        /// <summary>
        /// Rstr2binls the specified input.
        /// </summary>
        /// <param name="input">The input.</param>
        var i;
        var output = [];
      ...
      function rstr2hex(input) {
        /// <summary>
        /// Rstr2hexes the specified input.
        /// </summary>
        /// <param name="input">The input.</param>
  ...
  function pollUntil(_ref) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      function poll(duration, cumulativeDuration) {
        /// <summary>
        /// Polls the specified duration.
        /// </summary>
        /// <param name="duration">The duration.</param>
        /// <param name="cumulativeDuration">Duration of the cumulative.</param>
        setTimeout(function () {
          /// <summary>
          /// </summary>
          var result = fn();
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      /// Runs the diag.
      /// </summary>
      /// <param name="scriptOrLinkTag">The script or link tag.</param>
      ...
      var diagScriptFun = function diagScriptFun(nodeUnderTestId, testIconId, md5, parentOrigin) {
        /// <summary>
        /// Diags the script fun.
        /// </summary>
        /// <param name="nodeUnderTestId">The node under test identifier.</param>
        /// <param name="testIconId">The test icon identifier.</param>
        /// <param name="md5">The MD5.</param>
        /// <param name="parentOrigin">The parent origin.</param>
  ...
  function detectSvgConflicts(currentScript) {
    ...
    /// <var>The scripts by m d5</var>
    var scriptsByMD5 = {};

    /// <var>The loop</var>
    var _loop = function _loop(scriptIdx) {
      /// <summary>
      /// Loops the specified script index.
      /// </summary>
      /// <param name="scriptIdx">Index of the script.</param>
