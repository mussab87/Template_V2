...
Chart.defaults.global.defaultFontColor = "#9d7d24";
...
// Area Chart Example
var AllEmp = document.getElementById('AllEmp').value;
...
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
      labels: ["غائب", "اجازة", "مستأذن", "متأخر", "حاضر", "التعداد"],
    datasets: [{
      label: "موظف",
      lineTension: 0.3,
      backgroundColor: "rgba(78, 115, 223, 0.05)",
        borderColor: "#9d7d24",
      pointRadius: 3,
        pointBackgroundColor: "#9d7d24",
        pointBorderColor: "#9d7d24",
      pointHoverRadius: 3,
      pointHoverBackgroundColor: "#9d7d24",
      hoverBackgroundColor: "#9d7d24",
      pointHitRadius: 10,
      pointBorderWidth: 2,
        data: [NotCome, Vacation, Authorized, Late, Present, AllEmp],
    }],
  },
  options: {
